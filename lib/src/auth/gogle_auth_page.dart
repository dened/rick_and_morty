...
class _SignInDemoState extends State<SignInDemo> {
  ...
  String? _pickFirstNamedContact(Map<String, dynamic> data) {
    ...
    final contact =
        connections?.firstWhere((contact) => (contact as Map<Object?, dynamic>)['names'] != null, orElse: () => null)
            as Map<String, dynamic>?;
    if (contact != null) {
      final names = contact['names'] as List<dynamic>;
      final name =
          names.firstWhere((name) => (name as Map<Object?, dynamic>)['displayName'] != null, orElse: () => null)
              as Map<String, dynamic>?;
      if (name != null) {
  ...
  Widget _buildBody() {
    ...
    return Column(
      ...
      children: <Widget>[
        if (user != null) ..._buildAuthenticatedWidgets(user) else ..._buildUnauthenticatedWidgets(),
  ...
  List<Widget> _buildAuthenticatedWidgets(GoogleSignInAccount user) => <Widget>[
    ...
    if (_isAuthorized) ...<Widget>[
      ...
      ElevatedButton(onPressed: () => _handleAuthorizeScopes(user), child: const Text('REQUEST PERMISSIONS')),
    ],
  ...
  List<Widget> _buildUnauthenticatedWidgets() => <Widget>[
